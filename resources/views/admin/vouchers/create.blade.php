...
@section('page-description', 'Buat kode promo baru untuk pelanggan')
        ...
        <form action="{{ route('admin.vouchers.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" name="code" class="filter-input" placeholder="Contoh: HEMAT50" value="{{ old('code') }}" required style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                <div class="form-group">
                    ...
                    <input type="number" name="value" class="filter-input" placeholder="Contoh: 50000 atau 10" value="{{ old('value') }}" required style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px;">
                </div>
                
                <div class="form-group">
                    <label style="display: block; font-weight: 700; margin-bottom: 10px; font-size: 14px;">Minimal Belanja</label>
                    <input type="number" name="min_purchase" class="filter-input" placeholder="0" value="{{ old('min_purchase', 0) }}" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px;">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                <div class="form-group">
                    ...
                    <input type="number" name="max_discount" class="filter-input" placeholder="Opsional" value="{{ old('max_discount') }}" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px;">
                </div>
                
                <div class="form-group">
                    <label style="display: block; font-weight: 700; margin-bottom: 10px; font-size: 14px;">Batas Penggunaan</label>
                    <input type="number" name="usage_limit" class="filter-input" placeholder="Kosongkan jika tidak terbatas" value="{{ old('usage_limit') }}" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px;">
                </div>
            </div>

            <div class="form-group" style="margin-bottom: 30px;">
                <label style="display: block; font-weight: 700; margin-bottom: 10px; font-size: 14px;">Tanggal Kadaluarsa</label>
                <input type="date" name="expires_at" class="filter-input" value="{{ old('expires_at') }}" style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px;">
            </div>
            ...
            <div style="display: flex; gap: 15px; justify-content: flex-end; border-top: 1px solid #eee; padding-top: 20px;">
                ...
                <button type="submit" style="padding: 12px 35px; border-radius: 10px; background: var(--primary); color: white; border: none; font-weight: 700; cursor: pointer; box-shadow: 0 4px 15px rgba(229, 57, 53, 0.2);">Simpan Voucher</button>
            </div>
        </form>
    </div>
</div>
